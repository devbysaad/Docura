            ...
            <div className="relative z-10">
                ...
                <Card className="p-6 space-y-4">
                    ...
                    {(activeTool === "pdf-to-text" || activeTool === "split") && (
                        <div
                            className="border-2 border-dashed border-white/10 rounded-xl p-8 text-center cursor-pointer hover:border-accent/30 transition-colors"
                    ...
                    {result && (
                        <Card className="p-4 mt-4 bg-[#0F0F0F]">
